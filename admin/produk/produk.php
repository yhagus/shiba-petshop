                            ...
                            <?php foreach ($produk as $row) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="Hapus Produk" class="btn btn-outline-danger" href="hapus_produk.php?id_produk=<?= $row["id_produk"]; ?>" onclick="return confirm('hapus produk ini?');"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
